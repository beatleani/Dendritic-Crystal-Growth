% Initialization
x = 300; % Number of grids in x-direction
y = 300; % Number of grids in y-direction
counter = 0;
T = zeros(x,y); % Temperature matrix
p = zeros(x,y); % Phase field matrix
